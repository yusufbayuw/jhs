...
use App\Filament\Resources\SalesRecordResource\RelationManagers;
...
class SalesRecordResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateSalesRecord::route('/create'),
            'view' => Pages\ViewSalesRecord::route('/{record}'),
            'edit' => Pages\EditSalesRecord::route('/{record}/edit'),
        ];
    }
}
